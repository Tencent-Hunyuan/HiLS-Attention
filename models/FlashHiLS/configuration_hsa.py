...
class HSAConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        rope_theta=10000.0,
        rope_scaling=None,
        enable_inrange_rope=False,
        rope_context_length=None,
        rope_period_multiplier=1.0,
        ...
        **kwargs,
        ...
        self.enable_inrange_rope = enable_inrange_rope
        self.rope_context_length = rope_context_length if rope_context_length is not None else max_position_embeddings
        self.rope_period_multiplier = rope_period_multiplier
