...
from .lhsa_layer_pope_naive import LandmarkHSA
...
class HSAModel(Qwen3PreTrainedModel):
    ...
    def __init__(self, config: Qwen3Config):
        ...
        self.pop_emb = PoPERotaryEmbWrapper(config=config)
    ...
    def forward(
        ...
        **flash_attn_kwargs,
        ...
        pope_pos_embeddings = self.pop_emb(hidden_states, position_ids)
