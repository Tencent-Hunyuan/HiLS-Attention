...
def hils_model_forward(
    ...
    **flash_attn_kwargs,
    ...
    logger.warning_once(f"[hils_model_forward] training={self.training}, use_cache={use_cache}, gradient_checkpointing={self.gradient_checkpointing}")
