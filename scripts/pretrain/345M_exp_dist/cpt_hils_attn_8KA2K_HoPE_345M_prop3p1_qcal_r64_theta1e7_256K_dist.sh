...
export MODEL_CONFIG="configs/hils_attention/config_hils_attn_8KA2K_HoPE_345M_prop3p1_qcal_r64_theta1e7_256K.json"
...
export WANDB_NAME="hils_attn_8KA2K_HoPE_345M_prop3p1_qcal_r64_theta1e7_256K_dist"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/checkpoints/hils_attn_8KA2K_HoPE_345M_prop3p1_qcal_r64_theta1e7_256K_dist}"
