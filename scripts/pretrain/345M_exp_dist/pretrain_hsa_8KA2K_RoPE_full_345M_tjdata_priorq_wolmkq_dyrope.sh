...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_RoPE_345M_priorq_wolmkq_dyrope.json"
export CORPUS_PATH="${CORPUS_PATH:-data/dolma3_mix-6T-1025-partial-tokenized}"
export MAX_SEQ_LEN=8192
export WANDB_NAME="hsa_8KA2K_RoPE-priorq-wolmkq-dyrope"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/checkpoints/hsa_8KA2K_RoPE_full_345M_dist-priorq-wolmkq-dyrope}"
