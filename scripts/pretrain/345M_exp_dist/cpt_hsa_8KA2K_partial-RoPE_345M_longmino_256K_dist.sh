...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_HoPE_345M_lmk_bias_priorq_wloralmkq_loradim64_theta10000000_256K.json"
export MODEL_PATH="${MODEL_PATH:-outputs/checkpoints/hsa_8KA2K_HoPE_full_345M_dist-priorq-wloralmkq-loradim64/checkpoints/global_step_30000/hf_ckpt}"
export CORPUS_PATH="${CORPUS_PATH:-data/dolma3_long_tokenized}"
export MAX_SEQ_LEN=262144
export WANDB_NAME="hsa_8KA2K_HoPE_theta10000000_345M_256K_dist"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/checkpoints/hsa_8KA2K_HoPE_theta10000000_345M_256K_dist}"
