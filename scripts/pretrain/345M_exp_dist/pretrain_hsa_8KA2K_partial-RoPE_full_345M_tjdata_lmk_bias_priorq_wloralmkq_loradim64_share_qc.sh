...
export WANDB_NAME="hsa_8KA2K_HoPE-priorq-wloralmkq-loradim64_share_qc_fixrope"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/checkpoints/hsa_8KA2K_HoPE_full_345M_dist-priorq-wloralmkq-loradim64_share_qc_fixrope}"
