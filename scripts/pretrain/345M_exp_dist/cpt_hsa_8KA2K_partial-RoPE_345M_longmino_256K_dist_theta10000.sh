...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_HoPE_345M_lmk_bias_priorq_wloralmkq_loradim64_theta10000_256K.json"
...
export WANDB_NAME="hsa_8KA2K_HoPE_theta10000_345M_256K_dist"
export OUTPUT_DIR="${OUTPUT_DIR:-outputs/checkpoints/hsa_8KA2K_HoPE_theta10000_345M_256K_dist}"
