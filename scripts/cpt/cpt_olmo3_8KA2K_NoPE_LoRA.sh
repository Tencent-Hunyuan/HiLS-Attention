...
export MODEL_CONFIG="configs/olmo3_7B/olmo3_8KA2K_NoPE_LoRA.json"

export HF_CKPT="../../checkpoints/olmo3_8KA2K_NoPE_LoRA/pytorch_model.bin"
export MODEL_PATH="${HF_CKPT}"
export LOAD_CHECKPOINT_PATH=""

export CORPUS_PATH="../../data/dolma3_mix-6T-1025-500B/"
export MAX_SEQ_LEN=8192
export WANDB_NAME="olmo3_8KA2K_NoPE_LoRA"
export OUTPUT_DIR="../../checkpoints/olmo3_8KA2K_NoPE_LoRA"
