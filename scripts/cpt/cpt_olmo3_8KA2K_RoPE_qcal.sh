...
export MODEL_CONFIG="${MODEL_CONFIG:-configs/olmo3_7B/olmo3_8KA2K_RoPE_qcal.json}"

export HF_CKPT="${HF_CKPT:-../../checkpoints/olmo3_8KA2K_RoPE_qcal/pytorch_model.bin}"
...
export WANDB_NAME="${WANDB_NAME:-olmo3_8KA2K_RoPE_qcal}"
export OUTPUT_DIR="${OUTPUT_DIR:-../../checkpoints/olmo3_8KA2K_RoPE_qcal}"
