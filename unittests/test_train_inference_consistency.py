...
from models.FlashHiLS.modeling_qwen_hils import HiLSForCausalLM as QwenHiLSForCausalLM
...
def register_hils_model(model_type, model_cls):
    class EvalHiLSConfig(HiLSConfig):
        pass

    EvalHiLSConfig.model_type = model_type
    model_cls.config_class = EvalHiLSConfig
    _register_with_exist_ok(AutoConfig.register, model_type, EvalHiLSConfig)
    _register_with_exist_ok(AutoModelForCausalLM.register, EvalHiLSConfig, model_cls)


register_hils_model("qwen_hils", QwenHiLSForCausalLM)
